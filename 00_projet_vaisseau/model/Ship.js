class Ship {
  ...
  constructor(shipObj) {
    ...
    this.componentSlots = shipObj.componentSlots || {
      thruster: shipObj.componentSlots.thruster || null, // class: component
      hull: shipObj.componentSlots.hull || null, // class: component
      shield: shipObj.componentSlots.shield || null, // class: component
      engine: shipObj.componentSlots.engine || null, // class: component
      weapon: shipObj.componentSlots.weapon || null,
      radar: shipObj.componentSlots.radar || null,
  ...
  installcomponent(component, slot) {
    if (!this.componentSlots.hasOwnProperty(slot)) {
      throw new Error(`L'emplacement de la composante n'existe pas`);
    }
